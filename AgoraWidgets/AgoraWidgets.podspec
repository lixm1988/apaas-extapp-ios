Pod::Spec.new do |spec|
  ...
  spec.source_files = "Widgets/AgoraWidgets/Common/*.{h,m,swift}", "AgoraWidgets/RenderSpread/*.{h,m,swift}", "AgoraWidgets/Cloud/**/*.{h,m,swift}", "AgoraWidgets/Whiteboard/**/*.{h,m,swift}", "AgoraWidgets/ChatWidget/**/*.{h,m,bundle}","AgoraWidgets/RtmIM/**/*.{h,m,swift}"
