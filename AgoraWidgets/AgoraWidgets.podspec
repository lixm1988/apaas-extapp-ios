Pod::Spec.new do |spec|
  ...
  spec.source_files = "AgoraWidgets/Common/*.{h,m,swift}", "AgoraWidgets/RenderSpread/**/*.{h,m,swift}", "AgoraWidgets/Cloud/**/*.{h,m,swift}", "AgoraWidgets/Whiteboard/**/*.{h,m,swift}", "AgoraWidgets/ChatWidget/**/*.{h,m,swift}", "AgoraWidgets/RtmIM/**/*.{h,m,swift}","AgoraWidgets/Poller/**/*.{h,m,swift}"
