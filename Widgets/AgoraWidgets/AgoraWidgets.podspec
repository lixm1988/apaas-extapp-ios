Pod::Spec.new do |spec|
  ...
  spec.source_files  = "Widgets/AgoraWidgets/**/*.{h,m,swift}", "Chat/*.{h,m,swift}", "Common/*.{h,m,swift}","RenderSpread/*.{h,m,swift}", "Cloud/**/*.{h,m,swift}","Whiteboard/**/*.{h,m,swift}","RtmIM/**/*.{h,m,swift}"
